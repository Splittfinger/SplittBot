...
This repository contains the working Phase 0–3 desktop app plus its research and product/technical design:
...
Phase 0, Phase 1, Phase 2, and Phase 3 are implemented as a working Electron macOS application. The app uses the Codex runtime installed with ChatGPT, signs in through Codex-managed ChatGPT authentication, discovers the models available to the account, creates persistent agent threads, and resumes them after an application or App Server restart.
